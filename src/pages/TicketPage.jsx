...
const TicketPage = ({ editMode }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (editMode) {
      ...
      if (success) {
        ...
        console.log('edit mode ' + response.status)
      }
    }
    ...
    if (!editMode) {
      ...
      if (success) {
        ...
        console.log('not in edit mode ' + response.status)
      }
    }
  }
  ...
  return (
    <div className="ticket">
      <h1>{editMode ? 'Update Task' : 'Create Task'}</h1> 
          ...
          onSubmit={handleSubmit}>
            ...
            <section>
              ...
              <div className="img-preview">
                {formData.avatar && (
                  <img src={formData.avatar} alt={`${formData.owner} avatar`} />
                )}
              </div>
            </section>
        </form>
